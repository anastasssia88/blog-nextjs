...
const about = () => {
    return (
        <>
            <Section light auto>
                <Navbar />
                <Heading1 content="Hi, I’m Anastasia" />
                <Avatar src={linguanastya}/>
                <Text sm content="I’m a web developer with a bachelor's degree in linguistics. I’m fluent in Russian, English, and French. I'd love to help you become confident when speaking French by teaching you how to produce French sounds." />
                <Text sm content="In this blog, I want to share tips&tricks about French pronunciation,strategies for effective learning, and resources that I personally enjoy and find useful." />
